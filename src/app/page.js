...
const testimonials = [
    ...
    { name: 'Javier L.', opo: 'Ayudante de II.PP.', rating: 5, text: 'Después de probar varias academias, me quedo con OposTest. Directo al grano, sin paja. La app es rápida y funciona genial en el móvil.' },
...
const faqData = [
    { q: '¿Hay tests gratuitos en OposTest?', a: '¡Sí! Ofrecemos una prueba gratuita para que puedas experimentar la calidad de nuestra plataforma. Podrás realizar un número limitado de tests en la oposición que elijas para convencerte antes de suscribirte.' },
    ...
    { q: '¿Qué precio tiene la suscripción a OposTest?', a: 'Ofrecemos un plan de suscripción mensual muy asequible que te da acceso ilimitado a todas las preguntas de todas las oposiciones. Puedes consultar el precio actualizado y todas las ventajas en nuestra sección de "Precios".' },
];
