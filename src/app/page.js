...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        <div>
          {/* CORRECCIÓN: Aumentamos el tamaño del texto a 8xl */}
          <h1 className="text-8xl font-extrabold text-white drop-shadow-lg">
            Tu éxito empieza con la práctica.
          </h1>
          <p className="text-2xl mt-4 max-w-3xl mx-auto text-white drop-shadow-md">
      ...
      <div className="relative z-10" style={{ marginTop: '100vh' }}>
        <div className={`container mx-auto px-6 py-20 bg-white/80 backdrop-blur-md rounded-t-2xl shadow-2xl`}>
