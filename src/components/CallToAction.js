      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              href="/precios"
              className="group inline-flex items-center justify-center rounded-md bg-yellow-500 px-6 py-3 text-base font-semibold text-white shadow-sm hover:text-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary transition-colors"
            >
