...
export default function PreciosClient() {
  ...
  // Prefetch anticipado de páginas de retorno (una vez)
  useEffect(() => {
    router.prefetch('/pago-exitoso');
    router.prefetch('/pago-cancelado');
  }, [router]);

  const prefetchCheckoutReturns = () => {
    router.prefetch('/pago-exitoso');
    router.prefetch('/pago-cancelado');
  };
  ...
  const handleSubscribe = async (planKey) => {
    ...
    try {
      ...
      // Precalentamos las páginas de retorno justo antes de salir al checkout
      prefetchCheckoutReturns();
                ...
                <div key={p.key} className="min-w-full px-2 sm:px-6">
                  ...
                  <div className="mx-auto max-w-xl bg-white rounded-2xl shadow-xl px-6 sm:px-10 py-8">
                    ...
                    <button
                      ...
                      onPointerEnter={prefetchCheckoutReturns}
                      onFocus={prefetchCheckoutReturns}
